...
# upstream   https://github.com/CodingMomentum/ProxmoxVE.git (fetch)
# upstream   https://github.com/CodingMomentum/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/CodingMomentum/ProxmoxVE"
echo ""
