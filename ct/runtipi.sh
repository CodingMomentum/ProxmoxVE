...
ADDON_SCRIPT="https://raw.githubusercontent.com/CodingMomentum/ProxmoxVE/main/tools/addon/runtipi.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/CodingMomentum/ProxmoxVE/main/tools/addon/runtipi.sh)"
MIGRATION_EOF
