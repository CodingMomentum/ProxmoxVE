#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/CodingMomentum/ProxmoxVE/main/misc/build.func)
...
ADDON_SCRIPT="https://raw.githubusercontent.com/CodingMomentum/ProxmoxVE/main/tools/addon/coolify.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/CodingMomentum/ProxmoxVE/main/tools/addon/coolify.sh)"
MIGRATION_EOF
