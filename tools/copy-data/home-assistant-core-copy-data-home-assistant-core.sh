...
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/CodingMomentum/ProxmoxVE/mainmain/tools/copy-data//home-assistant-core-copy-data-home-assistant-core.sh)"
